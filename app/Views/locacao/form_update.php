...
echo form_input('TB_LOCACAO_TIPO', $locacao['TB_LOCACAO_TIPO']);
echo '<br>';

echo form_label('Valor');
echo form_input('TB_LOCACAO_VALOR', $locacao['TB_LOCACAO_VALOR']);
echo '<br>';

echo form_label('Data de Início');
echo form_input('TB_LOCACAO_DT_INICIO', $locacao['TB_LOCACAO_DT_INICIO']);
echo '<br>';

echo form_label('Data do Fim');
echo form_input('TB_LOCACAO_DT_FIM', $locacao['TB_LOCACAO_DT_FIM']);
echo '<br>';

echo form_label('ID do Cliente');
echo form_input('TB_CLIENTE_ID', $locacao['TB_CLIENTE_ID']);
echo '<br>';

echo form_label('ID do Funcionário');
echo form_input('TB_FUNCIONARIO_ID', $locacao['TB_FUNCIONARIO_ID']);
echo '<br>';

echo form_label('ID do Automóvel');
echo form_input('TB_AUTOMOVEL_ID', $locacao['TB_AUTOMOVEL_ID']);
echo '<br>';
